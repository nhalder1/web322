...
app.get('/', (req, res) => {
  res.render("home"); // Updated to render the "home" view
});

app.get('/about', (req, res) => {
  res.render("about"); // Updated to render the "about" view
});
...
app.use((req, res, next) => {
  res.status(404).render("404", { message: "I'm sorry, we're unable to find what you're looking for" });
  // Updated to render the "404" view with a custom error message
});
